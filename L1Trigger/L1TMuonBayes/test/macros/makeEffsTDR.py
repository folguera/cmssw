...
datasets = { 
    ...
    'SingleMu_PU200' : { 'path' : '/eos/cms/store/group/phys_muon/sesanche/overlap_oct17_2/Mu_FlatPt2to100-pythia8-gun/SingleMu_PU200/191017_094242/0000/',},
...
import pickle 
with open('tdr_eff_moreetabins_PU200.pickle', 'wb') as handle:
